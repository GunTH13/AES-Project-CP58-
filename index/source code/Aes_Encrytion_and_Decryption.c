...
int main()
{
  ...
  gotoxy(45,10);
  printf("please your select File or Text");
  gotoxy(45,11);
  printf("----------------------------");
  gotoxy(45,13);
  ...
  printf("the Data Encryption Standard (DES).");
  	if (strcmp(keep_en_de, "FD")==0){
  		gotoxy(45, 17);	
		printf("   please your close Program AES!");   //AUS
		gotoxy(45, 18);	
...
int de_or_en(int i){
  ...
  gotoxy(45, 10+i);
  printf("please your select encrypt or decrypt");
  gotoxy(45, 12+i);
  printf(">   Encrypt");
  gotoxy(45, 14+i);
  printf(">   Decrypt");
  gotoxy(45, 16+i);
  printf("ESC, if you want to back the Menu");
  gotoxy(45, 15+i);
  printf("---------------------------------------");
  gotoxy(45, 17+i);
  printf("---------------------------------------");
  ...
  while((ch = _getch()) != 13)  /* 13 = Enter key */
  {
  	if(ch == 72){
        ...
        gotoxy(45, 10+i);
  		printf("please you select encrypt or decrypt");
  		gotoxy(45, 12+i);
  		printf("    Encrypt");
		gotoxy(45, 14+i);
  		printf("--> Decrypt");
...
int function_exit(){
	...
	system("Aes_Encrytion_and_Decryption.exe");
	exit(0);
	int i;
	char text[50000],new_text[50000];
	int ch;
